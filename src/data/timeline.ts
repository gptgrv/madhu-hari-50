...
export const timelineEvents: TimelineEvent[] = [
  ...
  {
    year: "~1970s",
    title: "Madhu Gupta — Chemistry Scholar",
    titleHi: "रसायन शास्त्र की विदुषी",
    description: "At HPU, Madhu ji completed her MPhil in Chemistry, topped the exam, and impressed her professors so deeply that they encouraged her to continue on to a PhD.",
    icon: "🧪",
  },
  {
    year: "1976",
    title: "The Beginning",
    titleHi: "शुरुआत",
    description: "Dr Hari Gupta and Madhu ji tied the knot. A bond that would last a lifetime and beyond.",
    icon: "💍",
  },
  {
    year: "1976–80",
