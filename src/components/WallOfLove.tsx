...
export default function WallOfLove() {
  ...
  useEffect(() => {
    ...
    if (shouldOpen) {
      window.requestAnimationFrame(() => {
        document.getElementById("wall-of-love")?.scrollIntoView({ behavior: "smooth", block: "start" });
      });
    }
  }, []);
  ...
  return (
    <section id="wall-of-love" className="py-10 px-4 bg-cream-dark">
      <div className="max-w-6xl mx-auto">
        <h2 className="font-[family-name:var(--font-serif)] text-4xl md:text-5xl text-center font-bold text-text-dark mb-1">
          Wall of Love
        </h2>
        <p className="text-center text-gold-dark font-[family-name:var(--font-serif)] italic text-lg mb-3">
          प्यार की दीवार
        </p>
        <p className="text-center text-text-muted mb-6 max-w-2xl mx-auto text-sm">
          Share a memory, a moment, or your wishes for Hari &amp; Madhu on their golden anniversary.
        </p>

        {/* Form — always visible */}
        <div className="max-w-xl mx-auto mb-10 bg-white rounded-2xl p-6 shadow-md border border-gold-light/30">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Share a memory, wish, or message for Madhu and Dr Hari..."
                />
              </div>
